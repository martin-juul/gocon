...
export class AbstractRepository<Entity extends ObjectLiteral> {
     ...
     */
    protected createQueryBuilderFor<T>(entity: QbjectType<T>, alias: string): SelectQueryBuilder<T> {
     ...
     */
    protected getRepositoryFor<T>(entity: QbjectType<T>): Repository<T> {
     ...
     */
    protected getTreeRepositoryFor<T>(entity: QbjectType<T>): TreeRepository<T> {
