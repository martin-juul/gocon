...
import { FindConditions, FindManyOptions, FindOneOptions } from '../find-options';
import { DeepPartial, ObjectLiteral } from '../common';
...
export class Repository<Entity extends ObjectLiteral> {
   ...
   */
  update(criteria: string | string[] | number | number[] | Date | Date[] | FindConditions<Entity>, partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult> {
   ...
   * Does not check if entity exist in the database.
   */
  delete(criteria: string | string[] | number | number[] | Date | Date[] | FindConditions<Entity>): Promise<DeleteResult> {
   ...
   * Does not check if entity exist in the database.
   */
  softDelete(criteria: string | string[] | number | number[] | Date | Date[] | FindConditions<Entity>): Promise<UpdateResult> {
   ...
   * Does not check if entity exist in the database.
   */
  restore(criteria: string | string[] | number | number[] | Date | Date[] | FindConditions<Entity>): Promise<UpdateResult> {
   ...
   * Finds first entity that matches given conditions.
   */
  findOne(optionsOrConditions?: string | number | Date | FindOneOptions<Entity> | FindConditions<Entity>, maybeOptions?: FindOneOptions<Entity>): Promise<Entity | undefined> {
   ...
   * Finds first entity that matches given options.
   */
  findOneOrFail(id?: string | number | Date, options?: FindOneOptions<Entity>): Promise<Entity>;
   ...
   * Finds first entity that matches given conditions.
   */
  findOneOrFail(optionsOrConditions?: string | number | Date | FindOneOptions<Entity> | FindConditions<Entity>, maybeOptions?: FindOneOptions<Entity>): Promise<Entity> {
