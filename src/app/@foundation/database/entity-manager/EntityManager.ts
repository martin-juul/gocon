...
export class EntityManager {
     ...
     */
    update<Entity>(target: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|any, partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult> {
     ...
     * Condition(s) cannot be empty.
     */
    delete<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|any): Promise<DeleteResult> {
     ...
     * Condition(s) cannot be empty.
     */
    softDelete<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|any): Promise<UpdateResult> {
     ...
     * Condition(s) cannot be empty.
     */
    restore<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|any): Promise<UpdateResult> {
     ...
     */
    findOne<Entity>(entityClass: QbjectType<Entity>, id?: string|number|Date|ObjectID, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;
     ...
     * Finds first entity that matches given conditions.
     */
    async findOne<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, idOrOptionsOrConditions?: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|FindOneOptions<Entity>|any, maybeOptions?: FindOneOptions<Entity>): Promise<Entity|undefined> {
     ...
     */
    findOneOrFail<Entity>(entityClass: QbjectType<Entity>, id?: string|number|Date|ObjectID, options?: FindOneOptions<Entity>): Promise<Entity>;
     ...
     * Finds first entity that matches given conditions or rejects the returned promise on error.
     */
    async findOneOrFail<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, idOrOptionsOrConditions?: string|string[]|number|number[]|Date|Date[]|ObjectID|ObjectID[]|FindOneOptions<Entity>|any, maybeOptions?: FindOneOptions<Entity>): Promise<Entity> {
     ...
     */
    getMongoRepository<Entity>(target: QbjectType<Entity>|EntitySchema<Entity>|string): MongoRepository<Entity> {
