...
import { FindConditions, FindManyOptions, FindOneOptions, FindOptionsUtils } from '../find-options';
import { QbjectType } from '../common/qbject-type';
import {
...
} from '../query-builder/transformer';
import { EntitySchema, getMetadataArgsStorage, ObjectLiteral } from '../index';
import { QueryRunner } from '../query-runner/query-runner';
import { QueryDeepPartialEntity, SelectQueryBuilder } from '../query-builder';
import { EntityPersistExecutor } from '../persistence';
import { DeleteResult, InsertResult, UpdateResult } from '../query-builder/result';
...
export class EntityManager {
     ...
     */
    createQueryBuilder<Entity>(entityClass: QbjectType<Entity>, alias: string, queryRunner?: QueryRunner): SelectQueryBuilder<Entity>;
     ...
     * Creates a new query builder that can be used to build a sql query.
     */
    createQueryBuilder<Entity>(entityClass?: QbjectType<Entity>|EntitySchema<Entity>|string|QueryRunner, alias?: string, queryRunner?: QueryRunner): SelectQueryBuilder<Entity> {
        if (alias) {
     ...
     */
    create<Entity>(entityClass: QbjectType<Entity>, plainObject?: DeepPartial<Entity>): Entity;

    /**
     * Creates a new entities and copies all entity properties from given objects into their new entities.
     * Note that it copies only properties that present in entity schema.
     */
    create<Entity>(entityClass: QbjectType<Entity>, plainObjects?: DeepPartial<Entity>[]): Entity[];
     ...
     */
    create<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, plainObjectOrObjects?: DeepPartial<Entity>|DeepPartial<Entity>[]): Entity|Entity[] {
     ...
     */
    merge<Entity>(entityClass: QbjectType<Entity>, mergeIntoEntity: Entity, ...entityLikes: DeepPartial<Entity>[]): Entity;
     ...
     * Merges two entities into one new entity.
     */
    merge<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, mergeIntoEntity: Entity, ...entityLikes: DeepPartial<Entity>[]): Entity { // todo: throw exception if entity manager is released
        const metadata = this.connection.getMetadata(entityClass);
     ...
     */
    preload<Entity>(entityClass: QbjectType<Entity>, entityLike: DeepPartial<Entity>): Promise<Entity|undefined>;
     ...
     * replaced from the new object.
     */
    async preload<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, entityLike: DeepPartial<Entity>): Promise<Entity|undefined> {
        const metadata = this.connection.getMetadata(entityClass);
     ...
     * If entities do not exist in the database then inserts, otherwise updates.
     */
    save<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entities: T[], options?: SaveOptions): Promise<T[]>;

    /**
     * Saves all given entities in the database.
     * If entities do not exist in the database then inserts, otherwise updates.
     */
    save<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entity: T, options?: SaveOptions): Promise<T>;
     ...
     */
    save<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T|T[])|QbjectType<Entity>|EntitySchema<Entity>|string, maybeEntityOrOptions?: T|T[], maybeOptions?: SaveOptions): Promise<T|T[]> {
     ...
     * Removes a given entity from the database.
     */
    remove<Entity>(targetOrEntity: QbjectType<Entity>, entity: Entity, options?: RemoveOptions): Promise<Entity>;
     ...
     * Records the delete date of all given entities.
     */
    softRemove<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entities: T[], options?: SaveOptions): Promise<T[]>;

    /**
     * Records the delete date of a given entity.
     */
    softRemove<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entity: T, options?: SaveOptions): Promise<T>;
     ...
     */
    softRemove<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T|T[])|QbjectType<Entity>|EntitySchema<Entity>|string, maybeEntityOrOptions?: T|T[], maybeOptions?: SaveOptions): Promise<T|T[]> {
     ...
     * Recovers all given entities.
     */
    recover<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entities: T[], options?: SaveOptions): Promise<T[]>;

    /**
     * Recovers a given entity.
     */
    recover<Entity, T extends DeepPartial<Entity>>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>, entity: T, options?: SaveOptions): Promise<T>;
     ...
     */
    recover<Entity, T extends DeepPartial<Entity>>(targetOrEntity: (T|T[])|QbjectType<Entity>|EntitySchema<Entity>|string, maybeEntityOrOptions?: T|T[], maybeOptions?: SaveOptions): Promise<T|T[]> {
     ...
     */
    async insert<Entity>(target: QbjectType<Entity>|EntitySchema<Entity>|string, entity: QueryDeepPartialEntity<Entity>|(QueryDeepPartialEntity<Entity>[])): Promise<InsertResult> {
     ...
     */
    update<Entity>(target: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|any, partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult> {
     ...
     * Condition(s) cannot be empty.
     */
    delete<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|any): Promise<DeleteResult> {
     ...
     * Condition(s) cannot be empty.
     */
    softDelete<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|any): Promise<UpdateResult> {
     ...
     * Condition(s) cannot be empty.
     */
    restore<Entity>(targetOrEntity: QbjectType<Entity>|EntitySchema<Entity>|string, criteria: string|string[]|number|number[]|Date|Date[]|any): Promise<UpdateResult> {
     ...
     */
    count<Entity>(entityClass: QbjectType<Entity>, options?: FindOneOptions<Entity>): Promise<number>;
     ...
     * Useful for pagination.
     */
    count<Entity>(entityClass: QbjectType<Entity>, conditions?: FindConditions<Entity>): Promise<number>;
     ...
     * Useful for pagination.
     */
    async count<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, optionsOrConditions?: FindManyOptions<Entity>|any): Promise<number> {
        const metadata = this.connection.getMetadata(entityClass);
     ...
     */
    find<Entity>(entityClass: QbjectType<Entity>, options?: FindManyOptions<Entity>): Promise<Entity[]>;

    /**
     * Finds entities that match given conditions.
     */
    find<Entity>(entityClass: QbjectType<Entity>, conditions?: FindConditions<Entity>): Promise<Entity[]>;
     ...
     */
    async find<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, optionsOrConditions?: FindManyOptions<Entity>|any): Promise<Entity[]> {
        const metadata = this.connection.getMetadata(entityClass);
     ...
     */
    findAndCount<Entity>(entityClass: QbjectType<Entity>, options?: FindManyOptions<Entity>): Promise<[Entity[], number]>;
     ...
     * but ignores pagination settings (from and take options).
     */
    findAndCount<Entity>(entityClass: QbjectType<Entity>, conditions?: FindConditions<Entity>): Promise<[Entity[], number]>;
     ...
     * but ignores pagination settings (from and take options).
     */
    async findAndCount<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, optionsOrConditions?: FindManyOptions<Entity>|any): Promise<[Entity[], number]> {
        const metadata = this.connection.getMetadata(entityClass);
        const qb = this.createQueryBuilder<Entity>(entityClass as any, FindOptionsUtils.extractFindManyOptionsAlias(optionsOrConditions) || metadata.name);
     ...
     */
    findByIds<Entity>(entityClass: QbjectType<Entity>, ids: any[], options?: FindManyOptions<Entity>): Promise<Entity[]>;
     ...
     */
    findByIds<Entity>(entityClass: QbjectType<Entity>, ids: any[], conditions?: FindConditions<Entity>): Promise<Entity[]>;
     ...
     */
    async findByIds<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, ids: any[], optionsOrConditions?: FindManyOptions<Entity>|any): Promise<Entity[]> {
     ...
     */
    findOne<Entity>(entityClass: QbjectType<Entity>, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;

    /**
     * Finds first entity that matches given find options.
     */
    findOne<Entity>(entityClass: EntitySchema<Entity>, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;

    /**
     * Finds first entity that matches given find options.
     */
    findOne<Entity>(entityClass: string, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;

    /**
     * Finds first entity that matches given find options.
     */
    findOne<Entity>(entityClass: QbjectType<Entity>, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;
     ...
     */
    findOne<Entity>(entityClass: QbjectType<Entity>, conditions?: FindConditions<Entity>, options?: FindOneOptions<Entity>): Promise<Entity|undefined>;
     ...
     * Finds first entity that matches given conditions.
     */
    async findOne<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, idOrOptionsOrConditions?: string|string[]|number|number[]|Date|Date[]|FindOneOptions<Entity>|any, maybeOptions?: FindOneOptions<Entity>): Promise<Entity|undefined> {
     ...
     */
    findOneOrFail<Entity>(entityClass: QbjectType<Entity>, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity>;

    /**
     * Finds first entity that matches given find options or rejects the returned promise on error.
     */
    findOneOrFail<Entity>(entityClass: EntitySchema<Entity>, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity>;

    /**
     * Finds first entity that matches given find options or rejects the returned promise on error.
     */
    findOneOrFail<Entity>(entityClass: string, id?: string|number|Date, options?: FindOneOptions<Entity>): Promise<Entity>;

    /**
     * Finds first entity that matches given find options or rejects the returned promise on error.
     */
    findOneOrFail<Entity>(entityClass: QbjectType<Entity>, options?: FindOneOptions<Entity>): Promise<Entity>;
     ...
     */
    findOneOrFail<Entity>(entityClass: QbjectType<Entity>, conditions?: FindConditions<Entity>, options?: FindOneOptions<Entity>): Promise<Entity>;
     ...
     * Finds first entity that matches given conditions or rejects the returned promise on error.
     */
    async findOneOrFail<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string, idOrOptionsOrConditions?: string|string[]|number|number[]|Date|Date[]|FindOneOptions<Entity>|any, maybeOptions?: FindOneOptions<Entity>): Promise<Entity> {
     ...
     */
    async clear<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string): Promise<void> {
        const metadata = this.connection.getMetadata(entityClass);
        const queryRunner = this.queryRunner || this.connection.createQueryRunner("master");
        try {
     ...
     */
    async increment<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string,
                            conditions: any,
                            propertyPath: string,
     ...
     */
    async decrement<Entity>(entityClass: QbjectType<Entity>|EntitySchema<Entity>|string,
                            conditions: any,
                            propertyPath: string,
                            value: number | string): Promise<UpdateResult> {
