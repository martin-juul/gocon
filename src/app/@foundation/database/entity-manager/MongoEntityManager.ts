...
export class MongoEntityManager extends EntityManager {
     ...
     */
    async find<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, optionsOrConditions?: FindManyOptions<Entity> | Partial<Entity>): Promise<Entity[]> {
     ...
     */
    async findAndCount<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, optionsOrConditions?: FindManyOptions<Entity> | Partial<Entity>): Promise<[Entity[], number]> {
        const query = this.convertFindManyOptionsOrConditionsToMongodbQuery(optionsOrConditions);
        const cursor = await this.createEntityCursor(entityClassOrName, query);
        if (FindOptionsUtils.isFindManyOptions(optionsOrConditions)) {
            if (optionsOrConditions.select)
     ...
     */
    async findByIds<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, ids: any[], optionsOrConditions?: FindManyOptions<Entity> | Partial<Entity>): Promise<Entity[]> {
     ...
     */
    async findOne<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string,
     ...
     */
    async update<Entity>(target: QbjectType<Entity> | EntitySchema<Entity> | string, criteria: string | string[] | number | number[] | Date | Date[] | ObjectID | ObjectID[] | FindConditions<Entity>, partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult> {
     ...
     * Does not check if entity exist in the database.
     */
    async delete<Entity>(target: QbjectType<Entity> | EntitySchema<Entity> | string, criteria: string | string[] | number | number[] | Date | Date[] | ObjectID | ObjectID[] | FindConditions<Entity>): Promise<DeleteResult> {
        if (Array.isArray(criteria)) {
            await Promise.all((criteria as any[]).map(criteriaItem => {
     ...
     */
    createCursor<Entity, T = any>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query?: ObjectLiteral): Cursor<T> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    createEntityCursor<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query?: ObjectLiteral): Cursor<Entity> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    aggregate<Entity, R = any>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, pipeline: ObjectLiteral[], options?: CollectionAggregationOptions): AggregationCursor<R> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     * This returns modified version of cursor that transforms each result into Entity model.
     */
    aggregateEntity<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, pipeline: ObjectLiteral[], options?: CollectionAggregationOptions): AggregationCursor<Entity> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    bulkWrite<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, operations: ObjectLiteral[], options?: CollectionBulkWriteOptions): Promise<BulkWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    count<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query?: ObjectLiteral, options?: MongoCountPreferences): Promise<number> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    createCollectionIndex<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, fieldOrSpec: string | any, options?: MongodbIndexOptions): Promise<string> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    createCollectionIndexes<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, indexSpecs: ObjectLiteral[]): Promise<void> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    deleteMany<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, options?: CollectionOptions): Promise<DeleteWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    deleteOne<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, options?: CollectionOptions): Promise<DeleteWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    distinct<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, key: string, query: ObjectLiteral, options?: { readPreference?: ReadPreference | string }): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    dropCollectionIndex<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, indexName: string, options?: CollectionOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    dropCollectionIndexes<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndDelete<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, options?: { projection?: Object, sort?: Object, maxTimeMS?: number }): Promise<FindAndModifyWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndReplace<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, replacement: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    findOneAndUpdate<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, update: Object, options?: FindOneAndReplaceOption): Promise<FindAndModifyWriteOpResultObject> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    geoHaystackSearch<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, x: number, y: number, options?: GeoHaystackSearchOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    geoNear<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, x: number, y: number, options?: GeoNearOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    group<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, keys: Object | Array<any> | Function | Code, condition: Object, initial: Object, reduce: Function | Code, finalize: Function | Code, command: boolean, options?: { readPreference?: ReadPreference | string }): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    collectionIndexes<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     * Retrieve all the indexes on the collection.
     */
    collectionIndexExists<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, indexes: string | string[]): Promise<boolean> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    collectionIndexInformation<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: { full: boolean }): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    initializeOrderedBulkOp<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: CollectionOptions): OrderedBulkOperation {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    initializeUnorderedBulkOp<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: CollectionOptions): UnorderedBulkOperation {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    insertMany<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, docs: ObjectLiteral[], options?: CollectionInsertManyOptions): Promise<InsertWriteOpResult> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    insertOne<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, doc: ObjectLiteral, options?: CollectionInsertOneOptions): Promise<InsertOneWriteOpResult> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    isCapped<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    listCollectionIndexes<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: { batchSize?: number, readPreference?: ReadPreference | string }): CommandCursor {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    mapReduce<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, map: Function | string, reduce: Function | string, options?: MapReduceOptions): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    parallelCollectionScan<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: ParallelCollectionScanOptions): Promise<Cursor<Entity>[]> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    reIndex<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string): Promise<any> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     * Reindex all indexes on the collection Warning: reIndex is a blocking operation (indexes are rebuilt in the foreground) and will be slow for large collections.
     */
    rename<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, newName: string, options?: { dropTarget?: boolean }): Promise<Collection<any>> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    replaceOne<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, doc: ObjectLiteral, options?: ReplaceOneOptions): Promise<UpdateWriteOpResult> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    stats<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, options?: { scale: number }): Promise<CollStats> {
        const metadata = this.connection.getMetadata(entityClassOrName);
        return this.queryRunner.stats(metadata.tableName, options);
    }

    watch<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, pipeline?: Object[], options?: ChangeStreamOptions): ChangeStream {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    updateMany<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, update: ObjectLiteral, options?: { upsert?: boolean, w?: any, wtimeout?: number, j?: boolean }): Promise<UpdateWriteOpResult> {
        const metadata = this.connection.getMetadata(entityClassOrName);
     ...
     */
    updateOne<Entity>(entityClassOrName: QbjectType<Entity> | EntitySchema<Entity> | string, query: ObjectLiteral, update: ObjectLiteral, options?: ReplaceOneOptions): Promise<UpdateWriteOpResult> {
        const metadata = this.connection.getMetadata(entityClassOrName);
