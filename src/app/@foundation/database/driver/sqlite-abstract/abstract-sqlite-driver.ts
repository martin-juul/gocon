...
import { BaseConnectionOptions, Connection } from '../../connection';
import { RdbmsSchemaBuilder } from '../../schema-builder';
import { ColumnType, DataTypeDefaults, MappedColumnTypes } from '../types';
import { QueryRunner } from '../../query-runner';
import { TableColumn } from '../../schema-builder/table';
import { AbstractSqliteQueryRunner } from './abstract-sqlite-query-runner';
...
export abstract class AbstractSqliteDriver implements Driver {
   ...
   */
  queryRunner?: AbstractSqliteQueryRunner;
