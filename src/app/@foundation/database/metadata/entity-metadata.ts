...
import { CannotCreateEntityIdMapError } from '../error';
import { OrderByCondition } from '../find-options';
import { TableMetadataArgs, TreeMetadataArgs } from '../metadata-args';
import { OrmUtils, shorten } from '../util';
import { CheckMetadata } from './check-metadata';
import { ColumnMetadata } from './column-metadata';
import { EmbeddedMetadata } from './embedded-metadata';
import { EntityListenerMetadata } from './entity-listener-metadata';
import { ExclusionMetadata } from './exclusion-metadata';
import { ForeignKeyMetadata } from './foreign-key-metadata';
import { IndexMetadata } from './index-metadata';
import { RelationCountMetadata } from './relation-count-metadata';
import { RelationIdMetadata } from './relation-id-metadata';
import { RelationMetadata } from './relation-metadata';
import { TableType, TreeType } from './types';
...
export class EntityMetadata {
  ...
  build() {
    ...
    // TODO: Check if this introduces weird behavior
    // TODO: MODIFICATION!
    //else {
