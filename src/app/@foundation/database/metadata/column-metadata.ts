import { ColumnType } from '../driver/types';
...
import { ApplyValueTransformers, OrmUtils, PromiseUtils } from '../util';
import { ValueTransformer } from '../decorator/options';
...
export class ColumnMetadata {
  ...
  protected buildPropertyPath(): string {
    let path = this.joinEmbeddedParentPropertyNames();
  ...
  private joinEmbeddedParentPropertyNames(): string {
    let path = '';
