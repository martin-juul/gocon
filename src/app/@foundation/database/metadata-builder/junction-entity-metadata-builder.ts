import { ColumnMetadata, EntityMetadata, ForeignKeyMetadata, IndexMetadata, RelationMetadata } from '../metadata';
      ...
      return new ColumnMetadata({
        ...
        args: {
          ...
          options: {
            ...
            && (referencedColumn.generationStrategy === 'uuid' || referencedColumn.type === 'uuid') // TODO: GOCON HACK CHCEK
              ? '36'
      ...
      return new ColumnMetadata({
        ...
        args: {
          ...
          options: {
            ...
            && (inverseReferencedColumn.generationStrategy === 'uuid' || inverseReferencedColumn.type === 'uuid') // TODO: GOCON HACK CHCEK
              ? '36'
