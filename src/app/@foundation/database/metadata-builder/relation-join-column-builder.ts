import { ColumnMetadata, ForeignKeyMetadata, RelationMetadata, UniqueMetadata } from '../metadata';
import { JoinColumnMetadataArgs } from '../metadata-args';
        ...
        relationalColumn = new ColumnMetadata({
          ...
          args: {
            ...
            options: {
              ...
              && (referencedColumn.generationStrategy === 'uuid' || referencedColumn.type === 'uuid') // TODO: GOCON HACK CHECCK
                ? '36'
