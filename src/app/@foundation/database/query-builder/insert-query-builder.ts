...
import { InsertValuesMissingError, ReturningStatementNotSupportedError } from '../error';
import { ColumnMetadata } from '../metadata';
import { ReturningResultsEntityUpdator } from './returning-results-entity-updator';
import { AbstractSqliteDriver } from '../driver/sqlite-abstract';
import { SqljsDriver } from '../driver/sqljs';
import { BroadcasterResult } from '../subscriber/broadcaster-result';
...
export class InsertQueryBuilder<Entity> extends QueryBuilder<Entity> {
   ...
   */
  into<T>(entityTarget: QbjectType<T> | EntitySchema<T> | string, columns?: string[]): InsertQueryBuilder<T> {
