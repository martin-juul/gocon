...
import { NamingStrategyInterface } from '../naming-strategy';
import { DatabaseType } from '../driver/types';
import { Logger } from '..';
...
export interface BaseConnectionOptions {
  ...
  readonly cache?: boolean | {
     ...
     */
    readonly type?: 'database'; // todo: add mongodb and other cache providers as well in the future
