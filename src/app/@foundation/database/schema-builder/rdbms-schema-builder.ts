import { Table, TableCheck, TableColumn, TableExclusion, TableForeignKey, TableIndex, TableUnique } from './table';
import { QueryRunner } from '../query-runner/query-runner';
import { ColumnMetadata, EntityMetadata, ForeignKeyMetadata } from '../metadata';
  ...
  async build(): Promise<void> {
    ...
    try {
      ...
      try { // we throw original error even if rollback thrown an error
        ...
        this.connection.logger.log('warn', JSON.stringify(rollbackError));
      }
      throw error;
